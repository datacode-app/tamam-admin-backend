        ...
        if($request->button == 'import'){
            ...
            foreach ($collections as $key => $collection) {
                ...
                array_push($stores, [
                    ...
                    'halal_tag_status' => isset($collection['HalalTagStatus']) ? ($collection['HalalTagStatus'] == 1 || $collection['HalalTagStatus'] == 'yes') ? 1 : 0 : 1,
                ...
                if (!empty($allTranslations)) {
                    ...
                    if (!$translationResult) {
                        ...
                        \Log::warning('Multilingual translations failed to insert for bulk import', [
                            ...
                            'stores_imported' => count($data)
                        ]);
                        
                        // Show user-friendly message about multilingual data
                        Toastr::warning(translate('messages.stores_imported_but_translations_failed', ['count' => count($data)]));
                    } else {
