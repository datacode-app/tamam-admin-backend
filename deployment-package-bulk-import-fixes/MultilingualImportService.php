...
class MultilingualImportService
{
    ...
    public function processMultilingualData(array $data, string $modelClass, int $recordId): array
    {
        ...
        if (!isset($this->translatableFields[$modelClass])) {
            return $translations; // No translatable fields for this model
        }
        
        $fields = $this->translatableFields[$modelClass];
    ...
    private function getColumnVariations(string $field, string $langCode): array
    {
        ...
        $fieldMappings = [
            'name' => ['storeName', 'itemName', 'categoryName', 'brandName'],
     ...
     * Example: 'ckb' => ['ckb', 'ku']
     */
    private function getLangAliases(string $langCode): array
    {
        $aliases = [
            'ckb' => ['ckb', 'ku'],
            'ar' => ['ar'],
     ...
     * Example: 'ckb' => 'ku'
     */
    private function getDisplayLangCode(string $langCode): string
    {
        $display = [
            'ckb' => 'ku',
            'ar' => 'ar',
    ...
    {
        return $this->translatableFields[$modelClass] ?? [];
    }
