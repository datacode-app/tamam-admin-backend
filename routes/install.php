...
Route::post('system_settings', [InstallController::class, 'system_settings'])->name('system_settings')->middleware('installation-check');
Route::post('purchase_code', [InstallController::class, 'purchase_code'])->name('purchase.code')->middleware('installation-check');
