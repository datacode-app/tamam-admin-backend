...
Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin', 'current-module']], function () {
        ...
        Route::group(['prefix' => 'users', 'as' => 'users.'], function () {
            ...
            Route::get('disbursement-export/{id}/{type}', 'DeliveryMan\DeliveryManController@disbursement_export')->name('disbursement-export');
            Route::get('export', 'DeliveryMan\DeliveryManController@exportList')->name('export');
