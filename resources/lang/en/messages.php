<?php return array (
  ...
  'download_the_template_to_format_your_items_data' => 'Download the template to format your items data',
  'download_the_template_to_format_your_stores_data' => 'Download the template to format your stores data',
  'download_excel_template' => 'Download Excel Template',
  'upload_file' => 'Upload file',
  'supported_formats' => 'Supported Formats',
  'import_items' => 'Import Items',
  'import_stores' => 'Import Stores',
  'download_multilang_template' => 'Download Multilang Template',
  'template_supports_multiple_languages' => 'Template supports multiple languages',
  'upload_multilang_file' => 'Upload Multilang File',
  'multilang_support' => 'Multilang Support',
  'import_multilang_items' => 'Import Multilang Items',
  'import_multilang_stores' => 'Import Multilang Stores',
  'choose_import_type' => 'Choose Import Type',
  'import_food_items_restaurants' => 'Import food items for restaurants',
  'import_with_translations' => 'Import with multi-language support',
  'import_restaurants_stores' => 'Import restaurants and stores',
  'import_stores_with_translations' => 'Import stores with multi-language support',
  'get_formatted_template' => 'Get the formatted template for your data',
  'upload_your_file' => 'Upload Your File',
  'select_prepared_file' => 'Select your prepared Excel or CSV file',
  ...
  'no_keep_pending' => 'No - Keep pending review',
  'send_notifications' => 'Send Notifications',
  'yes_send_emails' => 'Yes - Send notification emails',
  'no_skip_emails' => 'No - Skip email notifications',
...
Smartly or Earn. ',
  ...
  'Stores Bulk Import' => 'Stores Bulk Import',
  'results' => 'Results',
  'Showing' => 'Showing',
  'Import completed!' => 'Import completed!',
  'multilang_import' => 'Multilingual Import',
  'get_multilingual_template' => 'Get multilingual template',
  'multilingual_template' => 'Multilingual Template',
  ...
  'import_grocery_stores' => 'Import grocery stores',
  'please_select_file' => 'Please select file',
  'multilang_import_items' => 'Multilang import items',
  'Finalizing import...' => 'Finalizing import...',
  'Processing items...' => 'Processing items...',
  'Validating data...' => 'Validating data...',
  'Yes, Start Import!' => 'Yes, Start Import!',
  'You can track the import progress in real-time' => 'You can track the import progress in real-time',
  ...
  'Supports: .xlsx, .xls, .csv files (max 10MB)' => 'Supports: .xlsx, .xls, .csv files (max 10MB)',
  'Drop files here or click to browse' => 'Drop files here or click to browse',
  'Modify existing items' => 'Modify existing items',
  'Update Existing Data' => 'Update Existing Data',
  'Add new items to your inventory' => 'Add new items to your inventory',
  'Upload New Data' => 'Upload New Data',
  'Select Import Type:' => 'Select Import Type:',
  'Upload File' => 'Upload File',
  'Max file size: 10MB' => 'Max file size: 10MB',
  'Save as .xlsx or .csv format' => 'Save as .xlsx or .csv format',
  'Fill data according to column headers' => 'Fill data according to column headers',
  'Use multilingual template for Arabic & Kurdish' => 'Use multilingual template for Arabic & Kurdish',
  'import_grocery_products' => 'Import grocery products',
  'Pro Tips:' => 'Pro Tips:',
  ...
  'Upload Excel files to import items with drag & drop support' => 'Upload Excel files to import items with drag & drop support',
  'Choose multilingual template if you want to add Kurdish Sorani and Arabic translations' => 'Choose multilingual template if you want to add Kurdish Sorani and Arabic translations',
  ...
  'Multilingual Template' => 'Multilingual Template',
  'Supports Kurdish & Arabic translations' => 'Supports Kurdish & Arabic translations',
  'Multilingual Templates' => 'Multilingual Templates',
  'Standard Templates' => 'Standard Templates',
  'please_fill_all_required_fields' => 'Please fill all required fields',
  'Pagination Navigation' => 'Pagination Navigation',
  'Download CSV fallback' => 'Download CSV fallback',
  'Having trouble downloading?' => 'Having trouble downloading?',
  'Item_doesnt_exist_at_the_database' => 'Item doesnt exist at the database',
  'Includes Arabic, Kurdish & English translations' => 'Includes Arabic, Kurdish & English translations',
  'Kurdish' => 'Kurdish',
  'Arabic' => 'Arabic',
  'Use these links if the above buttons require login' => 'Use these links if the above buttons require login',
  'Download Basic Template' => 'Download Basic Template',
  'Multilingual Export' => 'Multilingual Export',
  'Download Multilingual Template' => 'Download Multilingual Template',
);