...
$company_phone =BusinessSetting::where('key', 'phone')->first()?->value ?? 'Not Set';
$company_email =BusinessSetting::where('key', 'email_address')->first()?->value ?? 'Not Set';
$company_name =BusinessSetting::where('key', 'business_name')->first()?->value ?? 'Not Set';
$logo =BusinessSetting::where('key', 'logo')->first()?->value ?? 'Not Set';
$company_address =BusinessSetting::where('key', 'address')->first()?->value ?? 'Not Set';
$company_mobile_logo = $logo;
$company_links = json_decode(BusinessSetting::where('key','landing_page_links')->first()?->value ?? 'Not Set', true);
?>
<!DOCTYPE html>
<html>
<head>
