...
@push('script_2')
    ...
    <script async defer src="https://maps.googleapis.com/maps/api/js?key={{\App\Models\BusinessSetting::where('key', 'map_api_key')->first()?->value ?? 'Not Set'}}&callback=initialize&libraries=drawing,places&v=3.49"></script>
