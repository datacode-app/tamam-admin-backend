...
@push('script_2')
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key={{\App\Models\BusinessSetting::where('key', 'map_api_key')->first()?->value ?? 'Not Set'}}&libraries=places&callback=initMap&v=3.45.8"></script>
