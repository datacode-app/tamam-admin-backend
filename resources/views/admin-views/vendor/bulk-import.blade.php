            ...
            <div class="card-body">
                ...
                <div class="text-center pb-4">
                    ...
                    <div class="btn--container justify-content-center export--template-btns">
                        ...
                        <a href="{{route('admin.store.bulk-import')}}?download=template" class="btn btn--primary btn-outline-primary me-2">{{ translate('Standard Template') }}</a>
                        <a href="{{route('admin.store.bulk-import')}}?download=template&type=multilang" class="btn btn--success btn-outline-success">{{ translate('Multilingual Template (Kurdish & Arabic)') }}</a>
                        <div class="w-100 text-center mt-2">
                            <small class="text-muted">
                                {{ translate('Having trouble downloading?') }}
                                <a href="{{ asset('assets/stores_multilang_template.csv') }}" download>
                    ...
                    <div class="mt-2">
                        <small class="text-muted">{{ translate('Choose multilingual template if you want to add Kurdish Sorani and Arabic translations') }}</small>
                    </div>
                </div>
            </div>
        </div>
