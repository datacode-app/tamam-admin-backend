...
@section('title',translate('Multilingual Store Bulk Import'))
    ...
    <div class="content container-fluid">
        <div class="page-header">
            <h1 class="page-header-title">
                ...
                <span>
                    {{translate('messages.multilingual_stores_bulk_import')}}
                </span>
            </h1>
        </div>
        <!-- Content Row -->
        <div class="card">
            <div class="card-body">
                    ...
                    <div class="row g-4">
                        <div class="col-sm-6 col-lg-4">
                            <div class="export-steps-item-2 h-100">
                                ...
                                <ul class="m-0 pl-4">
                                    <li>
                                        {{ translate('Download_the_multilingual_template_file_and_fill_it_with_proper_data.') }}
                                    </li>
                                    <li>
                                        {{ translate('You_can_download_the_example_file_to_understand_how_the_multilingual_data_must_be_filled.') }}
                                    </li>
                                    <li>
                                        {{ translate('Have_to_upload_excel_file.') }}
                                    </li>
                                    <li>
                                        {{ translate('Multilingual_fields_include_Kurdish_Sorani_and_Arabic_translations.') }}
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="export-steps-item-2 h-100">
                                ...
                                <ul class="m-0 pl-4">
                                    ...
                                    <li>
                                       {{ translate('Kurdish_Sorani_and_Arabic_translations_will_be_automatically_saved.') }}
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="text-center pb-4">
                    <h3 class="mb-3 export--template-title font-regular">{{translate('download_multilingual_spreadsheet_template')}}</h3>
                    <div class="btn--container justify-content-center export--template-btns">

                        <a href="{{route('admin.store.bulk-import-multilang')}}?download=template" class="btn btn--primary btn-outline-primary">{{ translate('Multilingual Template with Sample Data') }}</a>
                        <a href="{{asset('assets/stores_multilang_template.xlsx')}}" download="" class="btn btn--primary">{{ translate('Empty Multilingual Template') }}</a>
        ...
        <form class="product-form" id="import_form" action="{{route('admin.store.bulk-import-multilang')}}" method="POST"
        ...
        <div class="card mt-2 rest-part">
            <div class="card-body">
                <div class="row g-3">
                        ...
                        <div class="module-radio-group border rounded">
                            <label class="form-check form--check">
                                ...
                                <span class="form-check-label py-20">
                                    {{ translate('Upload_New_Multilingual_Data') }}
                                </span>
                            </label>
                            <label class="form-check form--check">
                    ...
                    <div class="col-sm-6">
                        <h5 class="text-capitalize mb-3">{{ translate('Import_Multilingual_Stores_file') }}</h5>
                        <label class="uploadDnD d-block">
                            <div class="form-group inputDnD input_image input_image_edit position-relative">
                                <div class="upload-text">
                                    ...
                                    <div class="filename">{{translate('Must_be_Excel_files_using_our_multilingual_Excel_template_above')}}</div>
                                </div>
...
@push('script_2')
    <script>
        ...
        $('#reset_btn').click(function(){
        $('#products_file').val('');
        $('.filename').text('{{translate('Must_be_Excel_files_using_our_multilingual_Excel_template_above')}}');
        })
...
$(".action-upload-section-dot-area").on("change", function () {
    ...
    function myFunction(data) {
        ...
        text: "{{ translate('You_want_to_') }}" +data + " multilingual store data",
        type: 'warning',
