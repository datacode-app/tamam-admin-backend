...
@push('css_or_js')
<style>
  .export--template-btns .btn-outline-success,
  .export--template-btns .btn.btn--success.btn-outline-success {
    color: #198754 !important;
    border-color: #198754 !important;
    background-color: transparent !important;
  }
  .export--template-btns .btn-outline-primary,
  .export--template-btns .btn.btn--primary.btn-outline-primary {
    color: #0d6efd !important;
    border-color: #0d6efd !important;
    background-color: transparent !important;
  }
  .export--template-btns .btn-outline-success:hover,
  .export--template-btns .btn.btn--success.btn-outline-success:hover {
    color: #ffffff !important;
    background-color: #198754 !important;
    border-color: #198754 !important;
  }
  .export--template-btns .btn-outline-primary:hover,
  .export--template-btns .btn.btn--primary.btn-outline-primary:hover {
    color: #ffffff !important;
                ...
                <div class="export-steps-2">
                    <div class="row g-4">
                        ...
                        <div class="w-100 text-center mt-3">
                            <strong class="text-info">{{translate("Public Download Links (No Login Required)")}}</strong>
                            <div class="mt-2">
                                <a href="{{url('/bulk-template/items-multilang')}}" class="btn btn-sm btn-outline-info me-2">{{translate("Download Multilingual Template")}}</a>
                                <a href="{{url('/bulk-template/items')}}" class="btn btn-sm btn-outline-secondary">{{translate("Download Basic Template")}}</a>
                            </div>
                            <small class="text-muted d-block mt-1">
                                {{ translate("Use these links if the above buttons require login") }}
                            </small>
                        </div></div>
                </div>
                <div class="text-center pb-4">
                    <h3 class="mb-3 export--template-title font-regular">{{translate('download_spreadsheet_template')}}</h3>
                    <div class="btn--container justify-content-center export--template-btns flex-wrap">
                        <div class="mb-2">
                            <strong class="text-primary">{{translate('Standard Templates')}}</strong>
                        </div>
                        <div class="w-100 mb-2">
                            @if($module_type== 'food')
                            <a href="{{asset('assets/foods_bulk_format.xlsx')}}" download="" class="btn btn--primary btn-outline-primary me-2">{{translate('With Current Data')}}</a>
                            @else
                            <a href="{{asset('assets/items_bulk_format.xlsx')}}" download="" class="btn btn--primary btn-outline-primary me-2">{{translate('With Current Data')}}</a>
                                @endif
                        ...
                        <div class="w-100 mt-3 mb-2">
                            ...
                            <small class="text-muted d-block">{{translate('Supports Kurdish & Arabic translations')}}</small>
                        </div>
                        <div class="w-100 d-flex gap-2 justify-content-center flex-wrap">
                            <a href="{{route('admin.item.bulk-import')}}?download=template" class="btn btn--primary btn-outline-primary me-2">{{translate('Standard Template')}}</a>
                            <a href="{{route('admin.item.bulk-import')}}?download=template&type=multilang" class="btn btn--success btn-outline-success">{{translate('Multilingual Template (Kurdish & Arabic)')}}</a>
                            <div class="w-100 text-center mt-2">
                                <small class="text-muted">
                                    {{ translate('Having trouble downloading?') }}
                                    <a href="{{ asset('assets/items_multilang_template.csv') }}" download>
                                        {{ translate('Download CSV fallback') }}
                                    </a>
                                </small>
                            </div>
                        </div>
