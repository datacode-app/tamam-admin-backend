                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="form-group mb-0">
                                ...
                                <span class="pr-2">{{translate('messages.scheduled_trip')}}<span class="input-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{translate('When_enabled,_vendor_owner_can_take_scheduled_trips_from_customers.')}}"><img src="{{asset('assets/admin/img/info-circle.svg')}}" alt="{{translate('messages.scheduled_trip_hint')}}"></span></span>
                        ...
                        <form action="{{route('admin.rental.provider.update_settings',[$store['id']])}}" method="post"
                            ...
                            <div class="row">
                                <div class="form-group col-sm-6 col-lg-4">
                                    <label class="input-label text-capitalize" for="maximum_delivery_time">{{translate('messages.approx_pickup_time')}}<span class="input-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{translate('Set_the_total_time_to_deliver_products.')}}"><img src="{{asset('assets/admin/img/info-circle.svg')}}" alt="{{translate('Set_the_total_time_to_deliver_products.')}}"></span></label>
