...
@section('content')
                        ...
                        <div class="col-sm-6">
                            <div class="resturant-card card--bg-2">
                                ...
                                <img class="resturant-icon w--30"
                                     src="{{asset('assets/admin/img/transactions/pending.png')}}"
                                     alt="transaction">
                            </div>
                        </div>
    ...
    data-marker-icon="{{ asset('assets/admin/img/zone-status-on.png') }}"
...
@push('script_2')
    <!-- Page level plugins -->
    <script src="https://maps.googleapis.com/maps/api/js?key={{\App\Models\BusinessSetting::where('key', 'map_api_key')->first()?->value ?? 'Not Set'}}&callback=initMap&v=3.45.8"></script>
