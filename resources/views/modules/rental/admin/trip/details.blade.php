...
@section('content')
                                            ...
                                            <div class="media media--sm">
                                                <a class="avatar avatar-xl mr-3" href="{{ route('admin.rental.provider.vehicle.details', $detail->vehicle_id) }}">
                                                    <img class="img-fluid rounded aspect-ratio-1 onerror-image"
                                                         src="{{ data_get($detail?->vehicle,'thumbnailFullUrl',asset('assets/admin/img/160x160/img2.jpg') ) }}"
                                                ...
                                                @if(!in_array($trip->trip_status, ['ongoing','pending', 'completed', 'canceled']) && $is_deleted != 1)
                                                    <div class="mt-2">
                                                        <button
                                                            ...
                                                            data-img = "{{ data_get($detail?->vehicle,'thumbnailFullUrl',asset('assets/admin/img/160x160/img2.jpg') ) }}"
                                                ...
                                                <div class="media media--sm">
                                                    <a class="mr-3" href="#">
                                                        <img width="60" height="40" class="img--ratio-2 onerror-image rounded h--40px"
                                                             src="{{ data_get($vehicleDetails?->vehicles,'thumbnailFullUrl',asset('assets/admin/img/160x160/img2.jpg') ) }}"
                                                             data-onerror-image="{{ asset('assets/admin/img/160x160/img2.jpg') }}"
                                                             alt="Image Description">
                                                    </a>
                                                    <div class="media-body">
                        ...
                        <div class="media media--sm flex-wrap mb-20">
                            <a class="mr-3" href="#">
                                <img id="vehicleImage" width="160" class="img-fluid rounded aspect-2-1 onerror-image"
                                     src="{{ asset('assets/admin/img/car-demo.png') }}"
                                     data-onerror-image="{{ asset('assets/admin/img/car-demo.png') }}"
                                     alt="Image Description">
                            </a>
                            <div class="media-body">
                                <div class="text--title">
                                                ...
                                                <td>
                                                    <div class="media media--sm eta_amount">
                                                        <a class="avatar avatar-xl mr-3" href="{{ route('admin.rental.provider.vehicle.details', $editDetail->vehicle_id) }}">
                                                            <img class="img-fluid rounded aspect-ratio-1 onerror-image"
                                                                 src="{{ data_get($editDetail?->vehicle,'thumbnailFullUrl',asset('assets/admin/img/160x160/img2.jpg') ) }}"
                                                                 data-onerror-image="{{ asset('assets/admin/img/160x160/img2.jpg') }}"
                                                                 alt="Image Description">
                                                        </a>
                                                        <div class="media-body">
                                    ...
                                    <div class="col-md-9 col-lg-8">
                                        <dl class="row text-right text-title">
                                            ...
                                            <dt class="col-6 font-regular">{{translate('Vat/Tax')}}
                                                {{ \App\Models\BusinessSetting::where(['key'=>'tax_included'])->first()?->value ?? 'Not Set'  ? translate('(Included)') : '' }}
                                            </dt>

                                            <dd class="col-6 text-right tax_amount">
                                            {{ \App\Models\BusinessSetting::where(['key'=>'tax_included'])->first()?->value ?? 'Not Set'  ? '': '+'}} {{ \App\CentralLogics\Helpers::format_currency($trip->tax_amount)}}
                                            </dd>
    ...
    <div id="provider_logo" data-provider-logo="{{ $trip?->provider?->logo_full_url ?? asset('assets/admin/img/100x100/1.png') }}"></div>
    <div id="map-marker-image" data-map-marker-image="{{ asset('assets/admin/img/icons/pickup.svg') }}"></div>
...
@push('script_2')
    <script src="https://maps.googleapis.com/maps/api/js?key={{ \App\Models\BusinessSetting::where('key', 'map_api_key')->first()?->value ?? 'Not Set' }}&libraries=places&v=3.45.8"></script>
