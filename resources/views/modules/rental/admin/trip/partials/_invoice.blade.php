            ...
            <div class="print--invoice initial-38-1">
                @if ($trip?->provider)
                    <div class="text-center pt-4 mb-3">
                        <img class="invoice-logo" src="{{ asset('assets/admin/img/car_icon.svg') }}"
                             alt="">
                        <div class="top-info">
                            <h2 class="store-name">
                                 {{ $trip?->provider?->name }}
                            ...
                            <div>
                                <img src="{{ asset('assets/admin/img/location_icon.svg') }}" alt="">
                                {{ $trip?->provider?->address }}
                            </div>
                            <div class="mt-1 d-flex justify-content-center">
                                <span><img src="{{ asset('assets/admin/img/phone_icon.svg') }}" alt=""></span>&nbsp;
                ...
                <div class="img-wrap">
                    <div class="top-info">
                        ...
                        <img src="{{ asset('assets/admin/img/line_icon.svg') }}" alt="" class="w-100">
                    </div>
                    ...
                    <div class="order-info-details">
                        ...
                        <div><img src="{{ asset('assets/admin/img/line_icon.svg') }}" alt="" class="w-100"></div>
                    ...
                    <div class="top-info">
                        ...
                        <div class="copyright">
                            &copy; {{ \App\Models\BusinessSetting::where(['key' => 'business_name'])->first()?->value ?? 'Not Set' }}.
                            <span class="d-none d-sm-inline-block">{{ \App\Models\BusinessSetting::where(['key' => 'footer_text'])->first()?->value ?? 'Not Set' }}</span>
                        </div>
                    </div>
                </div>
            </div>
