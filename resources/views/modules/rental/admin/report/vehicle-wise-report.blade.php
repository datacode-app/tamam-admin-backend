                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="media align-items-center" href="{{ route('admin.rental.provider.vehicle.details', $vehicle->id)}}">
                                    ...
                                    src="{{ $vehicle?->thumbnail_full_url ?? asset('assets/admin/img/160x160/img2.jpg') }}"


                                    data-onerror-image="{{asset('assets/admin/img/160x160/img2.jpg')}}" alt="{{$vehicle->name}} image">
