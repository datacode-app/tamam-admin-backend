...
@push('css_or_js')
    <link rel="stylesheet" href="{{ asset('assets/admin/vendor/simplebar/dist/simplebar.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/admin/vendor/drift-zoom/dist/drift-basic.min.css') }}">
...
@section('content')
                ...
                <div>
                    <h1 class="page-header-title text-break">
                        <span class="page-header-icon">
                            <img src="{{ asset('assets/admin/img/car-logo.png') }}" alt="">
                        </span>
                        <span>{{ $vehicle->name }}
                    </h1>
                </div>
                    ...
                    <div class="card-body d-flex flex-column justify-content-center">
                        <a class="resturant--information-single" href="{{ route('admin.rental.provider.details', $vehicle->provider_id) }}">
                            <img class="img--65 rounded mx-auto mb-3 onerror-image" data-onerror-image=""
                                 src="{{ $vehicle?->provider?->logoFullUrl ?? asset('assets/admin/img/100x100/1.png') }}" alt="Image Description">
                    ...
                    <div class="pdf-single" data-pdf-url="{{ $doc }}">
                        ...
                        <div class="overlay">
                            ...
                            <div class="pdf-info d-flex gap-10px align-items-center">
                                <img src="{{ asset('assets/admin/img/document.svg') }}" width="34" alt="Document Logo">
    ...
    <div id="file-assets"
        ...
        data-document-path="{{ asset('assets/admin/img/icons') }}"
        data-default-thumbnail="{{ asset('assets/admin/img/blank2.png') }}">
    </div>
...
@push('script_2')
    ...
    <script src="{{ asset('assets/admin/vendor/drift-zoom/dist/Drift.min.js') }}"></script>
