...
@section('content')
    <div class="content container-fluid">
                        ...
                        <div class="pdf-single" data-pdf-url="{{ $doc }}">
                            ...
                            <div class="overlay">
                                ...
                                <div class="pdf-info d-flex gap-10px align-items-center">
                                    <img src="{{ asset('assets/admin/img/document.svg') }}" width="34" alt="{{translate('Document Logo')}}">
        ...
        <div class="card">
            ...
            <!-- End Header -->
            @php($store_review_reply = App\Models\BusinessSetting::where('key' , 'store_review_reply')->first()?->value ?? 'Not Set' ?? 0)
            <!-- Table -->
