...
<html dir="{{ $site_direction }}" lang="{{ $locale }}" class="{{ $site_direction === 'rtl'?'active':'' }} {{ in_array($locale, ['ar', 'ckb']) ? 'lang-'.$locale : '' }}">
<head>
    ...
    <!-- Additional CSS for RTL languages on login -->
    @if(in_array($locale, ['ar', 'ckb']))
    <style>
        body {
            font-family: 'Vazirmatn', 'Segoe UI', Tahoma, Arial, sans-serif !important;
        }
        
        .login-form, .login-title, .form-label, .form-control, .btn {
            font-family: 'Vazirmatn', 'Segoe UI', Tahoma, Arial, sans-serif !important;
        }
    </style>
    @endif
...
<body class="{{ in_array($locale, ['ar', 'ckb']) ? 'lang-'.$locale : '' }}">
<!-- ========== MAIN CONTENT ========== -->
    ...
    <div class="auth-wrapper">
        ...
        <div class="auth-wrapper-right">
            ...
            <div class="auth-wrapper-form">
                <!-- Form -->
                <form class="" action="/login_submit" method="post" id="form-id">
                    @csrf
                    ...
                    @if(!config('app.debug', false))
                        ...
                        @endif
                    @else
                        <!-- CAPTCHA disabled in debug mode -->
                        <div class="text-center mb-3">
                            <small class="text-muted">🔧 Debug Mode: CAPTCHA disabled</small>
                        </div>
                    @endif
...
@if(!config('app.debug', false) && isset($recaptcha) && $recaptcha['status'] == 1)
