    ...
    <div class="row justify-content-between align-items-center">
        <div class="col">
            <p class="font-size-sm mb-0">
                &copy; {{\App\Models\BusinessSetting::where(['key'=>'business_name'])->first()?->value ?? 'Tamam'}}. <span
                    class="d-none d-sm-inline-block">{{\App\Models\BusinessSetting::where(['key'=>'footer_text'])->first()?->value ?? 'Multi-Vendor Platform'}}</span>
            </p>
        </div>
        <div class="col-auto">
