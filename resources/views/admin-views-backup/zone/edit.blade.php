...
@push('script_2')
<script src="https://maps.googleapis.com/maps/api/js?v=3.45.8&key={{\App\Models\BusinessSetting::where('key', 'map_api_key')->first()?->value ?? 'Not Set'}}&libraries=drawing,places"></script>
<script>
    "use strict";
    auto_grow();
    function auto_grow() {
