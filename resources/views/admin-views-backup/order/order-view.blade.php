                        ...
                        @else
                            ...
                            <div class="table-responsive">
                                ...
                                if ($editing) {
                                    ...
                                    $tax_included = \App\Models\BusinessSetting::where(['key'=>'tax_included'])->first() ?  \App\Models\BusinessSetting::where(['key'=>'tax_included'])->first()?->value ?? 'Not Set' : 0;
                                    if ($tax_included ==  1){
                                        $total_tax_amount=0;
                                    }
                                    ...
                                    $free_delivery_over = \App\Models\BusinessSetting::where('key', 'free_delivery_over')->first()?->value ?? 'Not Set';
                                ...
                                @if ( !in_array($order->order_status, [ 'refunded', 'refund_request_canceled']))
                                    <div class="hs-unfold w-100">
                                        <div class="dropdown">
                                            ...
                                            @php($order_delivery_verification = (bool) \App\Models\BusinessSetting::where(['key' => 'order_delivery_verification'])->first()?->value ?? 'Not Set')
...
@push('script_2')
    ...
    <script
        src="https://maps.googleapis.com/maps/api/js?key={{ \App\Models\BusinessSetting::where('key', 'map_api_key')->first()?->value ?? 'Not Set' }}&libraries=places&v=3.45.8">
    </script>
    <script>
