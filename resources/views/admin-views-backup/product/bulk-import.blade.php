                ...
                <div class="text-center pb-4">
                    ...
                    <div class="btn--container justify-content-center export--template-btns flex-wrap">
                        ...
                        <div class="w-100 d-flex gap-2 justify-content-center flex-wrap">
                            <a href="{{asset('assets/items_multilingual_template.xlsx')}}" download="" class="btn btn--success btn-outline-success me-2">{{translate('With Sample Data (.xlsx)')}}</a>
                            <a href="{{asset('assets/items_multilingual_empty_template.xlsx')}}" download="" class="btn btn--success me-2">{{translate('Empty Template (.xlsx)')}}</a>
                        </div>
                        <div class="w-100 d-flex gap-2 justify-content-center flex-wrap mt-2">
                            <small class="text-muted">{{translate('Alternative formats:')}}</small>
                            <a href="{{asset('assets/items_multilingual_template.csv')}}" download="" class="btn btn-sm btn-outline-secondary me-1">{{translate('CSV with data')}}</a>
                            <a href="{{asset('assets/items_multilingual_empty_template.csv')}}" download="" class="btn btn-sm btn-outline-secondary">{{translate('CSV empty')}}</a>
                        </div>
                    </div>
                </div>
            </div>
