...
<script>
    ...
    // Language switching fix - ensure it works even if common.js fails
    $(document).ready(function () {
        // Override/backup language switching functionality
        $(".lang_link").off('click').on('click', function(e) {
            e.preventDefault();
            console.log('Language link clicked:', this.id);
            ...
            // Remove the hash from URL to prevent URL getting stuck
