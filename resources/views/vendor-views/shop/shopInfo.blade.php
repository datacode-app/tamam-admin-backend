            ...
            <div class="my-resturant--card">
                ...
                <div class="my-resturant--content">
                    ...
                    <span class="d-block mb-1 pb-1">
                        ...
                        <strong>{{translate('messages.admin_commission')}} : </strong> {{(isset($shop->comission)? $shop->comission:\App\Models\BusinessSetting::where('key','admin_commission')->first()?->value ?? 'Not Set')}}%
