                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-body">
                                ...
                                <div class="lang_form" id="default-form">
                                    ...
                                    <?php
                                        // 🚨 CRITICAL FIX: Initialize $translate OUTSIDE the loop to prevent reset
                                        $translate = [];
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="mt-3">
                                ...
                                <div class="text-center d-block" id="image-viewer-section" class="pt-2">
                                    ...
                                    src="{{ $product['image_full_url'] ?: asset('assets/admin/img/logo.png') }}"
                                            data-onerror-image ="{{asset('assets/admin/img/logo.png')}}"
                                            alt="product image"/>
                                </div>
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-md-12">
                                    <div class="customer_choice_options" id="customer_choice_options">
                                        @php($safeChoiceNo = json_decode($product['attributes'], true) ?? [])
                                        @php($safeChoiceOptions = json_decode($product['choice_options'], true) ?? [])
                                        @include('vendor-views.product.partials._choices',['choice_no'=>$safeChoiceNo,'choice_options'=>$safeChoiceOptions])
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="variant_combination" id="variant_combination">
                                        @php($safeVariations = json_decode($product['variations'], true) ?? [])
                                        @include('vendor-views.product.partials._edit-combinations',['combinations'=>$safeVariations,'stock'=>$module_data['stock']])
                                    </div>
                                </div>
                            </div>
                        </div>
