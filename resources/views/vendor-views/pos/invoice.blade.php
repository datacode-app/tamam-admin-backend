<div class="content container-fluid invoice-page">
    <div class="ff-emoji" id="printableArea">
        ...
        <div class="top-info mt-2">
            ...
            <img src="{{ asset('assets/admin/img/invoice-star.png') }}" alt="" class="w-100">
            <div class="copyright">
                &copy; {{ \App\Models\BusinessSetting::where(['key' => 'business_name'])->first()?->value ?? 'Not Set' }}. <span
                    class="d-none d-sm-inline-block">{{ \App\Models\BusinessSetting::where(['key' => 'footer_text'])->first()?->value ?? 'Not Set' }}</span>
            </div>
        </div>
    </div>
</div>
