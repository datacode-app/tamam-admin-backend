                ...
                <div class="col-lg-8">
                    <div class="row g-3">
                        <div class="col-sm-6 col-md-6">
                            ...
                            <span class="subtitle">{{translate('messages.in_progress_trips')}} <span data-toggle="tooltip" data-placement="right" data-original-title="{{translate('This count includes all the pending & confirmed trips')}}"><img src="{{asset('assets/admin/img/info-circle.svg')}}" alt="{{translate('messages.in_progress_trips')}}"></span></span>
