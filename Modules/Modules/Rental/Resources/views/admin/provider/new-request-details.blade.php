...
@section('content')
    <div class="content container-fluid">
                ...
                <div>
                    <h1 class="page-header-title text-break">
                        <span class="page-header-icon">
                            <img src="{{ asset('assets/admin/img/rental/provider-details.png') }}" class="w--22" alt="">
                        </span>
        ...
        <div class="taxi-banner radius-10 mt-4 mb-20"
             style="background-image: url('{{ $store->cover_photo_full_url ?? asset('assets/admin/img/100x100/1.png') }}'); background-repeat: no-repeat; background-position: center; background-size: cover;">
        <div class="taxi-info-wrapper d-flex flex-wrap flex-sm-nowrap gap-30px">
                <div class="logo">
                    <img data-onerror-image="{{asset('assets/admin/img/100x100/1.png')}}"
                         src="{{ $store->logo_full_url ?? asset('assets/admin/img/100x100/1.png') }}" width="150" class="rounded-8"
                         alt="">
                </div>
                <div class="taxi-info">
                    ...
                    <div class="details d-flex flex-wrap flex-column flex-sm-row gap-40px">
                        <div class="details-single d-flex align-items-center gap-2">
                            <img src="{{ asset('assets/admin/img/icons/zone.png') }}" width="36" height="36"
                                 class="rounded" alt="">
                            <div>
                        ...
                        <div class="details-single d-flex align-items-center gap-2">
                            <img src="{{ asset('assets/admin/img/icons/job-type.png') }}" width="36"
                        ...
                        <div class="details-single d-flex align-items-center gap-2">
                            <img src="{{ asset('assets/admin/img/rental/det-icon.png') }}" width="36"
                                 height="36" class="rounded" alt="">
                            <div>
                        ...
                        <div class="details-single d-flex align-items-center gap-2">
                            <img src="{{ asset('assets/admin/img/icons/vehicle-type.png') }}" width="36"
                                 height="36" class="rounded" alt="">
                            <div>
            ...
            <div class="modal-content">
                <div class="modal-body pt-5 p-md-5">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <img src="{{ asset('assets/admin/img/new-img/close-icon-dark.svg') }}" alt="">
                    </button>

                    <div class="d-flex justify-content-center mb-4">
                        <img width="75" height="75" src="{{ asset('assets/admin/img/modal/mark.png') }}"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body pt-5 p-md-5">
                    ...
                    <div class="d-flex justify-content-center mb-4">
                        <img width="75" height="75" src="{{ asset('assets/admin/img/icons/delete.png') }}"
                             class="rounded-circle" alt="">
                    </div>
