<div class="row g-2" id="order_stats">
    <div class="col-sm-6 col-lg-3">
        ...
        <a class="resturant-card dashboard--card __dashboard-card card--bg-1" href="{{ route('vendor.trip.list', ['status'=>'confirmed']) }}">
            ...
            <img src="{{ asset('assets/admin/img/rental/1.png') }}" alt="{{translate('img')}}" class="resturant-icon top-50px">
        </a>
        <!-- End Card -->
    </div>
    ...
    <div class="col-sm-6 col-lg-3">
        ...
        <a class="resturant-card dashboard--card __dashboard-card card--bg-2" href="{{ route('vendor.trip.list', ['status'=>'ongoing']) }}">
            ...
            <img src="{{ asset('assets/admin/img/rental/2.png') }}" alt="{{translate('img')}}" class="resturant-icon top-50px">
        </a>
        <!-- End Card -->
    </div>
    ...
    <div class="col-sm-6 col-lg-3">
        ...
        <a class="resturant-card dashboard--card __dashboard-card card--bg-3"
            ...
            <img src="{{ asset('assets/admin/img/rental/3.png') }}" alt="{{translate('img')}}" class="resturant-icon top-50px">
        </a>
        <!-- End Card -->
    </div>
    ...
    <div class="col-sm-6 col-lg-3">
        ...
        <a class="resturant-card dashboard--card __dashboard-card card--bg-4"
            ...
            <img src="{{ asset('assets/admin/img/rental/4.png') }}" alt="{{translate('img')}}" class="resturant-icon top-50px">
        </a>
        <!-- End Card -->
    </div>
