        ...
        <div class="page-header">
            <h1 class="page-header-title">
                <span class="page-header-icon">
                    <img src="{{ asset('assets/admin/img/rental/provider.png') }}" class="w--22" alt="">
                </span>
                <span>
        ...
        <div class="row g-3 mb-3">
            <div class="col-xl-3 col-sm-6">
                <div class="resturant-card card--bg-1">
                    ...
                    <img class="resturant-icon" src="{{asset('assets/admin/img/total_provider.png')}}" alt="store">
                </div>
            </div>
            <div class="col-xl-3 col-sm-6">
                <div class="resturant-card card--bg-3">
                    ...
                    <img class="resturant-icon" src="{{asset('assets/admin/img/active_provider.png')}}" alt="store">
                </div>
            </div>
            <div class="col-xl-3 col-sm-6">
                <div class="resturant-card card--bg-4">
                    ...
                    <img class="resturant-icon" src="{{asset('assets/admin/img/inactive_providers.png')}}" alt="store">
                </div>
            </div>
            <div class="col-xl-3 col-sm-6">
                <div class="resturant-card card--bg-2">
                    ...
                    <img class="resturant-icon" src="{{asset('assets/admin/img/new_provider.png')}}" alt="{{translate('provider')}}">
                </div>
            </div>
        </div>
