...
@section('content')
    ...
    <div id="default_image" data-url="{{ asset('assets/admin/img/picture.svg')}}"></div>
    <div id="default_document" data-url="{{ asset('assets/admin/img/document.svg')}}"></div>
    <div id="default_blank" data-url="{{ asset('assets/admin/img/blank2.png')}}"></div>
    <div id="default_blank_icon" data-url="{{ asset('assets/admin/img/icons')}}"></div>
@endsection
