...
class ExternalConfigurationController extends Controller
{
    public function getConfiguration()
    {
        ...
        $configs = [
            ...
            'logo' => \App\CentralLogics\Helpers::get_full_url('business', $logo?->value ?? 'business/tamam-default-logo.png', $logo?->storage[0]?->value ?? 'public', 'business') ?? asset('storage/business/tamam-default-logo.png'),
