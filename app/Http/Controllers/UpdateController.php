...
class UpdateController extends Controller
{
    ...
    public function update_software(Request $request)
    {
        ...
        Helpers::setEnvironmentValue('SOFTWARE_VERSION', config('app.version', '3.0'));
        Helpers::setEnvironmentValue('REACT_APP_KEY', config('app.react_app_key', '45370351'));
        Helpers::setEnvironmentValue('APP_NAME', config('app.name', '6amMart' . time()));
