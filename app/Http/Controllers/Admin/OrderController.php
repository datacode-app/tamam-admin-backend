...
class OrderController extends Controller
{
    ...
    /**
     * Add a delivery man to an order.
     *
     * @param  int  $order_id
    ...
    /**
     * Add a payment reference code to an order.
     *
     * @param  \Illuminate\Http\Request  $request
     * @param  int  $id
     * @return \Illuminate\Http\RedirectResponse
    ...
    /**
     * Add an order proof to an order.
     *
     * @param  \Illuminate\Http\Request  $request
     * @param  int  $id
     * @return \Illuminate\Http\RedirectResponse
    ...
    /**
     * Remove an order proof from an order.
     *
     * @param  \Illuminate\Http\Request  $request
     * @return \Illuminate\Http\RedirectResponse
     */
    ...
    /**
     * Display the refund settings page.
     *
     * @return \Illuminate\Contracts\View\View|\Illuminate\Contracts\View\Factory
     */
