...
use App\Traits\HasKurdishFallback;
...
{
    use ReportFilter, HasKurdishFallback;
    /**
    ...
    protected $fillable = [
        ...
        'comment',
        // 'delivery_service_type', // TEMPORARILY DISABLED - Fleet Management Feature
    ];
    ...
    // FLEET MANAGEMENT RELATIONSHIPS - TEMPORARILY DISABLED
    // TODO: Re-enable after completing database migrations and proper testing
    
    // /**
    //  * Get all business delivery drivers for this store.
    //  * 
    //  * @return HasMany
    //  */
    // public function businessDrivers(): HasMany
    // {
    //     return $this->hasMany(BusinessDeliveryFleet::class);
    // }

    // /**
    //  * Get only active business delivery drivers for this store.
    //  * 
    //  * @return HasMany
    //  */
    // public function activeBusinessDrivers(): HasMany
    // {
    //     return $this->hasMany(BusinessDeliveryFleet::class)->where('is_active', true);
    // }
